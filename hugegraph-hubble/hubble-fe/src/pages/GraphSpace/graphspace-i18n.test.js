...
test('GraphSpace UI does not contain hard-coded Chinese copy', () => {
...
test('GraphSpace translations are symmetric and English values contain no Chinese copy', () => {
    const enEntries = flatten(enPages.graphspace);
    const zhEntries = flatten(zhPages.graphspace);
