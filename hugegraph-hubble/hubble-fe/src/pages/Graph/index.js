    ...
    const getMenus = item => {
        ...
        return [
            ...
            },
            {
                ...
                onClick: sampleDisabled ? undefined : () => loadSample(item.name, 'hlm'),
            },
            {
                key: 'sample-rank',
                disabled: sampleDisabled,
                ...
                onClick: sampleDisabled ? undefined : () => loadSample(item.name, 'rank'),
            },
            {
                key: 'sample-loader',
                disabled: sampleDisabled,
                ...
                onClick: sampleDisabled ? undefined : () => loadSample(item.name, 'loader'),
            },
            {
                key: 'delete',
                danger: true,
